...
import Wallet from "metaglobe";
import { Transaction, TransactionFactory } from "metaglobe-transaction";
import Blockchain from "../../metaglobe/src/blockchain";
import { MetaglobeOptionsConfig } from "metaglobe-options";

describe("metaglobe-block", async () => {
