...
import { MetaglobeRawBlockHeader, serialize } from "./serialize";
...
import { StorageKeys } from "metaglobe-utils"
...
export class RuntimeBlock {
  ...
  finalize(
    ...
    const { header } = this;
    const rawHeader: MetaglobeRawBlockHeader = [
      header.parentHash,
